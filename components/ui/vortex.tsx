...
export function Vortex({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      // Use viewport dimensions instead of container to prevent
      // re-rendering when content (like accordions) changes height
    ...
    // Only resize on actual viewport changes, not content changes
